class ValidaFormulario {
  ...
  checkFields() {
    ...
    for (let campo of this.formulario.querySelectorAll('.validar')) {
      ...
      if (!campo.value.trim()) { // Verifica se o campo está vazio, ignorando espaços em branco
  ...
  validaUsuario(campo) {
    const usuario = campo.value.trim(); // Remove espaços em branco no início e no fim
    let valid = true;
